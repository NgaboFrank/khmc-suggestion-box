  ...
  return (
    <main className="page">
      <section className="hero">
        ...
        <p>We welcome feedback from everyone. Patients, visitors, staff and members of the community can share their thoughts anonymously.</p>
      </section>
      ...
      <form className="card form" onSubmit={submit}>
        ...
        <div className="privacy">
          ...
          <br />No name, phone number, department or other identifying information is required.
        </div>
